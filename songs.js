...
{
    src: "./src/Air Supply   Making Love Out Of Nothing At Al.mp3",
    name: "Making Love Out Of Nothing - Air Supply",
},
{
...
{
    src: "./src/Oasis   Do.mp3",
    name: "Do - Oasis",
},
{
    src: "./src/Richard Marx   Right Here Waiting (Official Music Video.mp3",
    name: "Right Here Waiting - Richard Marx ", 
},
{
    src: "./src/Roxette   It Must Have Been Love (Official Music Video.mp3",
    name: "It Must Have Been Love  - Roxette ", 
},
{
    src: "./src/Scorpions   Wind Of Change (World Events Version.mp3",
    name: "Wind Of Change  - Scorpions ", 
},
{
    src: "./src/Secret Service   The Way You Ar.mp3",
    name: " The Way You - Secret Service", 
},
{
